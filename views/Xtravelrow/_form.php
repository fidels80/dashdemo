...
<div class="xtravelrow-form">
    <div class="card-body row">
        <div class="col-md-6">
            <?php echo Html::a('Torna indietro', Yii::$app->request->referrer ?:
                ['index'], [
    ...
    <div class="card">
        ...
        <div class="card-body row">
            ...
            <div class="col-md-3"><?= $form->field($model, 'ruolo')->widget(Select2::class, [
                                        'options' => [
            ...
            <div class="col-md-2"><?= $form->field($model, 'party')->widget(Select2::class, [
                                        'data' => $partyOptions,
                                        'options' => [
        ...
        <div class="card-body row">
            <div class="col-md-4"><?= $form->field($model, 'cd_Ar')->widget(Select2::class, [
                                        'options' => [
                                            'placeholder' => 'Please select...',
                                        ],
                                        'pluginOptions' => [
...
JS
    ...
    <div class="card">
        ...
        <div class="card-body row">
            <div class="col-md-4"><?= $form->field($model, 'citta_da')->widget(Select2::class, [
                                        'options' => [
                                            'placeholder' => 'Please select...',
                                        ],
                                        'pluginOptions' => [
            ...
            <div class="col-md-4"><?= $form->field($model, 'citta_a')->widget(Select2::class, [
                                        'options' => [
                                            'placeholder' => 'Please select...',
                                        ],
                                        'pluginOptions' => [
    ...
    JS
            ...
            <div class="col-md-6"><?= $form->field($model, 'x_scdesc')
                                        ->textInput(['maxlength' => true])->label('Descrizione Commessa') ?></div>
        </div>

        <div class="card-body row">
            <div class="col-md-4"><?= $form->field($model, 'cd_cf_ft')->widget(Select2::class, [
                                        'options' => [
                                            'placeholder' => 'Please select...',
                                        ],
                                        'pluginOptions' => [
...
JS
            ...
            <div class="col-md-4"><?= $form->field($model, 'descli')->textInput(['maxlength' => true])->label('Descrizione Cliente') ?></div>
        </div>
        <div class="card-body row">
            <div class="col-md-4"><?= $form->field($model, 'citta')->widget(Select2::class, [
                                        'options' => [
                                            'placeholder' => 'Please select...',
                                        ],
                                        'pluginOptions' => [
            ...
            <div class="col-md-4"><?= $form->field($model, 'struttura')->widget(Select2::class, [
                                        'options' => [
                                            'placeholder' => 'Please select...',
                                        ],
                                        'pluginOptions' => [
        ...
        <div class="card-body row">
            <div class="col-md-4"><?= $form->field($model, 'fornitore')->widget(Select2::class, [
                                        'options' => [
                                            'placeholder' => 'Please select...',
                                        ],
                                        'pluginOptions' => [
...
JS
            ...
            <div class="col-md-4"><?= $form->field($model, 'desfor')->textInput(['maxlength' => true])->label('Descrizione Fornitore') ?></div>
        </div>
...
<div class="card">
    ...
    <div class="card-body row">
        ...
        <div class="col-md-2"><?= $form->field($model, 'cd_pg')->widget(Select2::class, [
                                    'options' => [
                                        'placeholder' => 'Please select...',
                                    ],
                                    'pluginOptions' => [
...
<div class="card">
    ...
    <div class="col-md-10"><?= $form->field($model, 'note')->textarea(['rows' => 4]) ?></div>
