...
->where(['=','cd_cli','C004241'])
->orwhere(['=','cd_cli','C001443'])
->asArray()
->all();
...
echo $form->field($model, 'ischief')->checkBox(['label' => 'E\' utente vivenda','data-size'=>'small', 'class'=>'bs_switch'

,'style'=>'margin-bottom:4px;', 'id'=>'acischieftive']);
