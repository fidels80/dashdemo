...
<div class="xruoli-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Crea Ruoli', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    columns: [
    { title: 'Ruolo', data: 'cd_ruolo', width: '100px' },
    { title: 'Descrizione', data: 'descrizione', width: '100px' },
            ...
            // Pulsante View
            actions +='<a href=\"" . \yii\helpers\Url::to(['view']) . "&cd_ruolo=' + row.cd_ruolo + '\" ' +
                                  ' class=\"btn btn-sm btn-primary\" title=\"Visualizza\" style=\"margin: 1px;\">' +
            '<i class=\"fas fa-eye\"></i></a>';

    // Pulsante Update
    actions += '<a href=\"" . \yii\helpers\Url::to(['update']) . "&cd_ruolo=' + row.cd_ruolo + '\" ' +
                                  ' class=\"btn btn-sm btn-info\" title=\"Modifica\" style=\"margin: 1px;\">' +
        '<i class=\"fas fa-edit\"></i></a>';

    // Pulsante Delete
    actions += '<a href=\"" . \yii\helpers\Url::to(['delete']) . "&cd_ruolo=' + row.cd_ruolo + '\" ' +
