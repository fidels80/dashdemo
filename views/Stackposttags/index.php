...
--mese ,
ltrim(rtrim(str(anno)))+'/'+(right('00'+ltrim(rtrim(str(mese))),2))+'/01' as dat,
count(tagname) as somma--//,tagname
...
order by cast(anno as int) asc ,cast(mese as int ) asc");
        ...
        foreach ($flutter as $value) {
            $xflutter[] = [$value['dat'], $value['somma']];
        }
        $command = $connection->createCommand("select
ltrim(rtrim(str(anno)))+'/'+(right('00'+ltrim(rtrim(str(mese))),2))+'/01' as dat,
--mese ,
...
order by cast(anno as int) asc ,cast(mese as int ) asc");
        ...
        $xxamarin = [];
        foreach ($xamarin as $value) {
            $xxamarin[] = [$value['dat'], $value['somma']];
        }
...
order by cast(anno as int) asc ,cast(mese as int ) asc");
        ...
        //$xcordova[] = 0;
        foreach ($cordova as $value) {
            $xcordova[] = [$value['dat'], $value['somma']];
        }
...
order by cast(anno as int) asc ,cast(mese as int ) asc");
        ...
        //$xcordova[] = 0;
        foreach ($angular as $value) {
            $xangular[] = [$value['dat'], $value['somma']];
        }
...
<div>
    <row>
        ...
        $content1 = $this->render('@app/views/rapportini/index', [
            'dataProvider' => $dataProvider, 'searchModel' => $searchModel
        ]);

        $content2 =    Url::to(['doc_head/index']);
        $content3 = '3asdad';
        $content4 = '4asdad';
