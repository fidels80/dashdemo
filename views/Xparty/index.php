...
/* @var $searchModel app\models\XRuoliSearch */
...
<div class="xparty-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Crea Party', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
...
$this->registerJs("
    ...
    columns: [
    { title: 'Party', data: 'cd_party', width: '100px' },
    { title: 'Descrizione', data: 'descrizione', width: '100px' },
                {
            title: 'Azioni' ,
            data: null,
            orderable: false,
            ...
            // Pulsante View
            actions +='<a href=\"" . \yii\helpers\Url::to(['view']) . "&cd_party=' + row.cd_party + '\" ' +
                                  ' class=\"btn btn-sm btn-primary\" title=\"Visualizza\" style=\"margin: 1px;\">' +
            '<i class=\"fas fa-eye\"></i></a>';

    // Pulsante Update
    actions += '<a href=\"" . \yii\helpers\Url::to(['update']) . "&cd_party=' + row.cd_party + '\" ' +
                                  ' class=\"btn btn-sm btn-info\" title=\"Modifica\" style=\"margin: 1px;\">' +
        '<i class=\"fas fa-edit\"></i></a>';

    // Pulsante Delete
    actions += '<a href=\"" . \yii\helpers\Url::to(['delete']) . "&cd_party=' + row.cd_party + '\" ' +
