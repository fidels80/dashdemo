...
namespace app\modules\dintable;
use yii;
...
class Module extends \yii\base\Module
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'app\modules\dintable\controllers';
...
return $href;
    ...
    $this->_assetsUrl=str_replace('web','',Yii::$app->request->baseUrl).'modules/Dintable';
