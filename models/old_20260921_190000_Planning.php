...
class Planning extends \yii\db\ActiveRecord
{
    ...
    public function afterFind()
    {
        ...
        // --- NUOVO: Popola l'array dei veicoli leggendo dalla nuova tabella ponte ---
        $this->veicoli_ids = \yii\helpers\ArrayHelper::getColumn(
            \Yii::$app->db->createCommand('SELECT veicolo_id FROM planning_veicoli WHERE planning_id = :id')
    ...
    public function getVeicoliCompleti()
    {
        ...
        return !empty($veicoli) ? implode(', ', $veicoli) : 'Senza Mezzo';
    }
