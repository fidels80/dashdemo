...
class Ls extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(CF::className(), ['Cd_LS_1' => 'Cd_LS']);
    }
    ...
    {
        return $this->hasMany(CF::className(), ['Cd_LS_2' => 'Cd_LS']);
    }

    /**
     * Gets query for [[Dittas]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getDittas()
    {
        return $this->hasMany(Ditta::className(), ['WebB2C_Cd_LS' => 'Cd_LS']);
    }
    ...
    {
        return $this->hasMany(DORig::className(), ['Cd_LS_C' => 'Cd_LS']);
    }
    ...
    {
        return $this->hasMany(DOTes::className(), ['Cd_LS_1' => 'Cd_LS']);
    }
    ...
    {
        return $this->hasMany(DOTes::className(), ['Cd_LS_2' => 'Cd_LS']);
    }

    /**
     * Gets query for [[DOTes1]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getDOTes1()
    {
        return $this->hasMany(DOTes::className(), ['Cd_LS_C' => 'Cd_LS']);
    }

    /**
     * Gets query for [[EShopOrders]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getEShopOrders()
    {
        return $this->hasMany(EShopOrder::className(), ['Cd_LS' => 'Cd_LS']);
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getCdVL()
    {
        return $this->hasOne(VL::className(), ['Cd_VL' => 'Cd_VL']);
    }
    ...
    {
        return $this->hasMany(LSRevisione::className(), ['Cd_LS_Base' => 'Cd_LS']);
    }

    /**
     * Gets query for [[LSRevisiones0]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getLSRevisiones0()
    {
        return $this->hasMany(LSRevisione::className(), ['Cd_LS' => 'Cd_LS']);
    }

    /**
     * Gets query for [[VBConfiguraziones]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getVBConfiguraziones()
    {
        return $this->hasMany(VBConfigurazione::className(), ['Cd_LS' => 'Cd_LS']);
    }
}
