 ...
 * @property string $nfile
 */
class Folders   extends \kartik\tree\models\Tree
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            'movable_u', 'movable_d', 'movable_l', 'movable_r', 'removable', 'removable_all', 'child_allowed'],
             'integer'],
            [['name'], 'required'],
            [['name'], 'string', 'max' => 60],
            [['icon','nfile'], 'string', 'max' => 255],
             [['f_content'], 'string']
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'nfile'=>'Descrizione File',
            'f_content'=>'Carica File'
        ];
    }
