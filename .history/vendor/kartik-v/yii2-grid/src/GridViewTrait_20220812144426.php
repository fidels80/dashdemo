...
HTML;
    ...
    protected function initExport()
    {
        ...
        $title = empty($this->caption) ? Yii::t('kvgrid', 'esposta') : $this->caption;
        $pdfHeader = [
            'L' => [
                'content' => Yii::t('kvgrid', 'Portal  Exporta (PDF)'),
                'font-size' => 8,
                'color' => '#333333',
            ],
            'C' => [
            ...
            'R' => [
                'content' => Yii::t('kvgrid', 'Generato il ').': '.date('dd-mm-yyyy'),
                'font-size' => 8,
                'color' => '#333333',
            ],
        ];
        $pdfFooter = [
            'L' => [
                'content' => Yii::t('kvgrid', '©Ilvbc 2022'),
                'font-size' => 8,
                'font-style' => 'B',
                'color' => '#999999',
            ],
