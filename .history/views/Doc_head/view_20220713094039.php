...
*/
switch(true){
case $model->confermato<>1  && $model->rifiutato<>1;
   echo Html::a('Conferma', ['conferma', 'id' => $model->id],
         ['class' => 'btn btn-primary']);  
       echo Html::a('Rifiuta', ['rifiuta', 'id' => $model->id],
         ['class' => 'btn btn-primary']); 
case $model->confermato==1:           
echo \hail812\adminlte\widgets\Alert::widget([
    'type' => 'success',
    'body' => '<h3>Documento Confermato!</h3>',
]);
case $model->rifiutato==1 :           
echo \hail812\adminlte\widgets\Alert::widget([
    'type' => 'danger',
...
echo '<br>';
echo $model->rifiutato;
echo '<br>';
echo $model->confermato;
echo '<br>';
