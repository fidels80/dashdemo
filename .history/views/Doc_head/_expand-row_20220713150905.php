...
echo '<table id="product-parcels" class="kv-grid-table table table-bordered table-striped kv-table-wrap">';
echo '<thead>';
echo '<tr>';
...
echo '<table id="product-files" class="kv-grid-table table table-bordered table-striped kv-table-wrap">';
echo '<thead>';
echo '<tr>';
//echo '<th>id_agenda</th>';
echo '<th>file</th>';
