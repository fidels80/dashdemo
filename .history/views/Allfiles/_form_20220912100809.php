...
echo \hail812\adminlte\widgets\Alert::widget([
    'type' => 'warning',
    'body' => 'la finestra di caricamento file si chiuderà da sola quando i files saranno invati',
]);
?>
    <?php //
   ...
   ?>
    ...
    <?php echo $form->field($model, 'f_content')->fileInput(['multiple' => true])->label('segli File')?>
