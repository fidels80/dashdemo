...
$pie=[];
$pie[]=array('Confermati'=>$resulconf[0]['tot']);
$pie[]=array('In attesa'=>$resulwait[0]['tot']);
$pie[]=array('Rifiutati'=>$resulcanc[0]['tot']);
$pie[]=array('Evasi'=>$resuleva[0]['tot']);
//$pie[]='pagate'=>500;
   ...
   // 'width' => '500', // default 100%
    'chartOptions' => [
        'chart' => [
            ...
            'labels'=>['Confermato','In attesa','Rifiutato','Evaso']
        ],
