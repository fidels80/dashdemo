...
<div class="card">
    <div class="card-body login-card-body">
        ...
        <?php $form = \yii\bootstrap4\ActiveForm::begin(['id' => 'login-form',  'action' => ['site/login']]) ?>
...
$url = Url::to(['allfiles/ajupd', 'xid_testa' => 15, 'tab' => 'DOTES',
//   'mod'->$model
]);
...
?>
      ...
      <!--   <div class="social-auth-links text-center mb-3">
        ...
        echo Html::a('Reimposta Password', ['RequestPasswordReset','reset'=>1]);
