    ...
    <div class="row">
        <div class="col-lg-5">
            <?php $form = ActiveForm::begin(['id' => 'form-signup', 'action' =>['site/signup']]); ?>
                ...
                <?= $form->field($model, 'password')->passwordInput(['id' => 'password','pattern'=>'/^(?=.*[0-9])(?=.*[A-Z])([a-zA-Z0-9]+)$/']) ?>
                <?=$form->field($model, 'password')->passwordInput(['id' => 'password2','pattern'=>'/^(?=.*[0-9])(?=.*[A-Z])([a-zA-Z0-9]+)$/'])?>
