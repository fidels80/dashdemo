...
?>" 
            ...
            <div class="info">
                <a href="<?=Url::toRoute(['/user/update', 'id' => Yii::$app->user->id])?>
                " class="d-block"><?php echo \yii\helpers\Html::encode( 
                   Yii::$app->user->identity->username) ?>
                 <!--    <br>
                    Ultimo Acceso:<br><?php echo date_format(date_create($ris['lastlogin']),"d/m/Y H:i") ?> -->   
        </a></div>
        </div>
