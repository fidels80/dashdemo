...
<tr>
 ...
 <tr>
      <td width="33%">  <?= $form->field($model, 'data')->textInput(['size'=>5]) ?></td>

    <td width="33%"><?= $form->field($model, 'ora_in')->textInput(['size'=>5]) ?></td>

    <td width="33%"><?= $form->field($model, 'ora_out')->textInput(['size'=>5]) ?></td>
 </tr>
