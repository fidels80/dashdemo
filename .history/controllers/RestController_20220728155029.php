...
values
( 
       CAST( :contenuto as VARBINARY) ,'DOTES',:descrizione,:filename,:EntityId,getdate(),0,:filesize,
            '\\web0o\upload\',
            'caricato da web',
            'YII',
            1,
...
"
                ...
                ->bindValue(':EntityId', $id,\PDO::PARAM_INT)
            ...
            'EntityId' => $id])
            // ->where(['id_dotes'=>$id])*/
                ->bindValue(':contenuto', $content,\PDO::PARAM_LOB)
                 ->execute();
