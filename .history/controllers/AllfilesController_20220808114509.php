...
$ldoc=doc_head::find()->where(['xid_testa'=>$model->id_padre])->one()->AsArray();

$subject="Caricamento dei file per il cliente ".$ldoc['cd_cli'];
$body="Sono stati caricati dei file ".PHP_EOL." Sono relativi al documento ".$ldoc['cd_doc']. ' numero ' .$ldoc['numdoc']. ' del ' .$ldoc['data'].PHP_EOL.'Saluti ';
